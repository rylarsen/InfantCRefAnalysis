...
%Create Table S4, columns AB from Larsen et al, NMR in Biomedicine
...
%we are only using the raw values
tbl = removevars(tbl,{'sd','sd_o','range_norm','range_norm_sd'});

filename = 'TableS4_columnsAB.xlsx';
